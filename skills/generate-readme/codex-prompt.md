...
4. Write README.md (стандарт DotCore)
5. Write AGENTS.md, .cursor/rules/dotcore-project.mdc, CLAUDE.md (project-rules.md)
6. Validate (audit.md, минимум 8/10)
7. LoC через code-counter

Факты только из кода. Перегенерируй файлы целиком. Сохрани SVG-обложку и LoC-бейдж.
